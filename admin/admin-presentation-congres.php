...
<body>
    ...
    if(isset($_POST["modifier"])){
        ...
        $modifier = $bdd->prepare("UPDATE congres SET titre=?, texte=?, dates=? WHERE id = ?");
    ...
    if(isset($_POST["creer"])){
        $bdd->exec("INSERT INTO `congres` (`id`,`titre`,`texte`,`dates` ) VALUES (NULL, '', '', '')");
    }

    if(isset($_POST["supprimer"])){
        $delete = $bdd->prepare("DELETE FROM congres WHERE id = ?");
