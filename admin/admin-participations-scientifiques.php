...
<body>
    ...
    <h1>Participations scientifiques</h1>
    ...
    if(isset($_POST["modifier"])){
        ...
        $modifier = $bdd->prepare("UPDATE participations SET titre=?, texte=?, dates=? WHERE id = ?");
    ...
    if(isset($_POST["creer"])){
        $bdd->exec("INSERT INTO `participations` (`id`, `titre`, `texte`, `dates`) VALUES (NULL, '', '', '')");
    }

    if(isset($_POST["supprimer"])){
        $delete = $bdd->prepare("DELETE FROM participations WHERE id = ?");
